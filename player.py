...
class Player(circleshape.CircleShape):
    ...
    def shoot(self, dt):
        if self.timer <= 0:
            shotR = shot.Shot(self.position.x, self.position.y, constants.SHOT_RADIUS)
            shotR.velocity = pygame.Vector2(0,1).rotate(self.rotation) * constants.PLAYER_SHOT_SPEED
